...
type BgmId = 'default' | 'sprint' | 'gravity' | 'colorMatch' | 'slime' | 'mirror'
...
const BGM_PATTERNS: Record<BgmId, BgmPattern> = {
  ...
  // slime 専用BGM: 跳ねる・ポップなサウンド (A major, BPM 138)
  slime: {
    bpm: 138,
    melody: [
      // pattern: [0,2,4,5,4,2,5,7,5,4,2,0,2,4,0,2] → scale indices → note keys
      ['A3',  0.5], ['Db4', 0.5], ['E4',  0.5], ['Fs4', 0.5],
      ['E4',  0.5], ['Db4', 0.5], ['Fs4', 0.5], ['A4',  0.5],
      ['Fs4', 0.5], ['E4',  0.5], ['Db4', 0.5], ['A3',  0.5],
      ['Db4', 0.5], ['E4',  0.5], ['A3',  0.5], ['Db4', 0.5],
    ],
    bass: [
      ['A3', 1], ['E4', 1], ['A3', 1], ['E4', 1],
      ['D4', 1], ['A3', 1], ['D4', 1], ['A3', 1],
  ...
  // mirror 専用BGM: 神秘的・対称的なサウンド (G minor, BPM 108)
  mirror: {
    bpm: 108,
    melody: [
      // pattern: [0,7,3,5,1,6,2,4,3,5,0,7,4,2,6,1] → scale indices → note keys
      ['G3',  0.5], ['G4',  0.5], ['C4',  0.5], ['Eb4', 0.5],
      ['A3',  0.5], ['F4',  0.5], ['Bb3', 0.5], ['Db4', 0.5],
      ['C4',  0.5], ['Eb4', 0.5], ['G3',  0.5], ['G4',  0.5],
      ['Db4', 0.5], ['Bb3', 0.5], ['F4',  0.5], ['A3',  0.5],
    ],
    bass: [
      ['G3', 1], ['D3', 1], ['G3', 1], ['D3', 1],
